...
const PinDescription g_APinDescription[] = {
    ...
    // 6: FAN signal
    {PORTA, 8, PIO_COM, PIN_ATTR_NONE, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER,
     EXTERNAL_INT_NONE},

    // 7: PUMP signal
    {PORTA, 9, PIO_COM, PIN_ATTR_NONE, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER,
     EXTERNAL_INT_NONE},

    // 8: Fan PWM
    {PORTA, 10, PIO_DIGITAL, (PIN_ATTR_DIGITAL | PIN_ATTR_PWM), ADC_Channel16,
     PWM0_CH0, NOT_ON_TIMER, EXTERNAL_INT_NONE},
