...
const PinDescription g_APinDescription[]=
{
  ...
  // Pins 1-12 are exposed for general use
  // TODO: configure the options for these
  // 1
  ...
  // 19: we need at least one analog pin
  { PORTA,  6, PIO_ANALOG, PIN_ATTR_ANALOG, ADC_Channel0, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // ADC/AIN[6]
